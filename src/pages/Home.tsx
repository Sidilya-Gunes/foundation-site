...
const Home: React.FC<HomeProps> = ({ setPage }) => {
  ...
  const formatArticle = (item: any): NewsItem => {
    let category: string = item.category || 'Uncategorized';
    ...
    <div className="animate-in fade-in duration-1000">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 animate-in slide-in-from-left duration-1000">
               ...
               <h1 className="text-5xl md:text-7xl font-serif font-extrabold leading-[1.1] text-brand-purple-900 tracking-tight">
                 Shared Dreams,<br/>
                 <span className="text-brand-purple-500">Beautiful Future.</span>
               </h1>
               
               <p className="text-lg md:text-xl text-gray-600 leading-relaxed max-w-lg">
                 Growing stronger with solidarity, we change the world with education and love. An equal and dignified life is possible for everyone.
               </p>
              ...
              <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl border-4 border-white transform rotate-2 hover:rotate-0 transition-transform duration-500">
                 ...
                 <div className="absolute bottom-8 left-8 bg-white/95 backdrop-blur p-4 rounded-2xl shadow-xl flex items-center space-x-4 max-w-xs animate-bounce-slow">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-brand-purple-500 font-medium uppercase tracking-wide">Happy Volunteers</p>
                    </div>
                 </div>
              </div>
            </div>
      ...
      <section className="pt-24 pb-20 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div>
              <h2 className="text-3xl font-serif font-bold text-brand-purple-900">News & Announcements</h2>
              <p className="text-gray-500 mt-2">Latest news and events from the foundation.</p>
            </div>
            <button 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12">
            <div className="max-w-xl">
               <span className="text-brand-purple-600 font-bold uppercase tracking-widest text-xs mb-2 block">Thought & Analysis</span>
               <h2 className="text-4xl font-serif font-bold text-brand-purple-900 leading-tight">Blog & Articles</h2>
               <p className="text-gray-600 mt-4 text-lg">In-depth analysis and insights from experts in their fields.</p>
            </div>
            ...
            {featuredKalem ? (
              ...
              >
                <div className="aspect-video overflow-hidden">
                  <img src={featuredKalem.imageUrl} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" alt="Featured Article" />
                </div>
                <div className="p-8">
                  <span className="text-brand-yellow-500 font-bold text-xs uppercase tracking-widest mb-3 block">Featured</span>
              ...
              <div className="lg:col-span-7 p-8 bg-white rounded-2xl text-center text-gray-400 border border-dashed border-gray-200">No articles yet.</div>
            )}
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-brand-purple-900 mb-4">Reports and Research</h2>
            <p className="text-gray-500 font-light text-lg">
              Access our comprehensive reports prepared for data-driven advocacy here.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {latestReports.length > 0 ? latestReports.map((report, i) => (
              ...
              <div className="col-span-full text-center py-8 text-gray-500 bg-gray-50 rounded-xl border border-dashed border-gray-200">No reports published yet.</div>
            )}
          </div>
      ...
      <section className="py-24 bg-brand-purple-900 relative overflow-hidden text-center">
         ...
         <div className="max-w-4xl mx-auto px-4 relative z-10">
            <h2 className="text-3xl md:text-5xl font-serif font-bold text-white mb-6">Be a Part of the Change</h2>
            <p className="text-brand-purple-100 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed font-light">
               Contact us to learn more about our projects or to support us.
            </p>
